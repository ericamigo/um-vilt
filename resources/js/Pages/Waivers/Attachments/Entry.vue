...
function destroy() {
    form.delete(route('waivers.attachments.destroy', { waiver: props.waiver.id, attachment: props.attachment.ulid }), {
        preserveScroll: true,
...
<template>
    <div class="-mx-3 flex gap-4 rounded-lg p-3 duration-150 hover:bg-neutral-100 dark:hover:bg-neutral-800">
        ...
        <div class="flex gap-2">
            <div>
                <a
                    :href="route('waivers.attachments.destroy', { waiver: waiver.id, attachment: attachment.ulid })"
