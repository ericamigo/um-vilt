...
export default {
    ...
    safelist: ['demo1', 'hidden', { pattern: /^apexcharts-.*$/ }, { pattern: /^leaflet-.*$/ }],
    ...
    theme: {
        ...
        custom: ({ theme }) => ({
            components: {
                ...
                container: {
                    fixed: {
                        px: { DEFAULT: theme('spacing')['6'], xl: theme('spacing')['7.5'] },
                        'max-width': theme('screens.xl'),
                    },
                    fluid: { px: { DEFAULT: theme('spacing')['6'], xl: theme('spacing')['7.5'] } },
                },
                btn: {
                    xs: {
                        height: '1.75rem',
                ...
                input: { sm: { px: '0.625rem' }, DEFAULT: { px: '0.75rem' }, lg: { gap: '0.875rem' } },
                checkbox: {
                    sm: { size: '1.125rem', borderRadius: '0.25rem' },
                    DEFAULT: { size: '1.375rem', borderRadius: '0.375rem' },
                    lg: { size: '1.625rem', borderRadius: '0.5rem' },
                },
                radio: { sm: { size: '1.125rem' }, DEFAULT: { size: '1.375rem' }, lg: { size: '1.625rem' } },
                switch: {
                    sm: { height: '1.125rem', width: '1.875rem' },
                    DEFAULT: { height: '1.375rem', width: '2.125rem' },
                    lg: { height: '1.625rem', width: '2.375rem' },
                },
                card: {
                    ...
                    grid: { px: theme('spacing.5') },
                },
                table: {
                    px: { xs: '0.5rem', sm: '0.75rem', DEFAULT: '1rem', lg: '1.25rem' },
                    py: {
                        xs: { head: '0.225rem', body: '0.35rem' },
                        sm: { head: '0.425rem', body: '0.5rem' },
                        DEFAULT: { head: '0.625rem', body: '0.75rem' },
                        lg: { head: '0.825rem', body: '0.95rem' },
                    },
                },
            },
            layouts: {
                demo1: {
                    sidebar: { width: { desktop: '280px', desktopCollapse: '80px', mobile: '280px' } },
                    header: { height: { desktop: '70px', mobile: '60px' } },
                },
            },
        }),
    },
    ...
    plugins: [
        forms,
        require('./resources/core/plugins/plugin'),
        require('./resources/core/plugins/components/theme'),
        require('./resources/core/plugins/components/breakpoints'),
        require('./resources/core/plugins/components/typography'),
        require('./resources/core/plugins/components/menu'),
        require('./resources/core/plugins/components/dropdown'),
        require('./resources/core/plugins/components/accordion'),
        require('./resources/core/plugins/components/input'),
        require('./resources/core/plugins/components/input-group'),
        require('./resources/core/plugins/components/select'),
        require('./resources/core/plugins/components/textarea'),
        require('./resources/core/plugins/components/file-input'),
        require('./resources/core/plugins/components/switch'),
        require('./resources/core/plugins/components/checkbox'),
        require('./resources/core/plugins/components/radio'),
        require('./resources/core/plugins/components/range'),
        require('./resources/core/plugins/components/container'),
        require('./resources/core/plugins/components/image-input'),
        require('./resources/core/plugins/components/modal'),
        require('./resources/core/plugins/components/drawer'),
        require('./resources/core/plugins/components/tooltip'),
        require('./resources/core/plugins/components/popover'),
        require('./resources/core/plugins/components/btn'),
        require('./resources/core/plugins/components/btn-group'),
        require('./resources/core/plugins/components/tabs'),
        require('./resources/core/plugins/components/pagination'),
        require('./resources/core/plugins/components/card'),
        require('./resources/core/plugins/components/table'),
        require('./resources/core/plugins/components/badge'),
        require('./resources/core/plugins/components/rating'),
        require('./resources/core/plugins/components/scrollable'),
        require('./resources/core/plugins/components/progress'),
        require('./resources/core/plugins/components/apexcharts'),
        require('./resources/core/plugins/components/leaflet'),
    ],
}
